...
![QuickView app icon](/guides/quickview/screenshots/QuickView_app_icon_with_text.png){ width="12%", align=right }

QuickView has been updated to version 2.7.8 with more comprehensive [colormap customization](guides/quickview/individual_views) capabilities.
...
![NERSC logo](/logos/nersc.png){width="18%"}

QuickView and QuickCompare have been deployed to [NERSC](https://www.nersc.gov/) through [JupyterHub](https://jupyter.nersc.gov/) for further development and testing.
